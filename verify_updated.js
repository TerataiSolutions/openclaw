...
async function verify() {
    const url = `${SUPABASE_URL}/rest/v1/memories?select=id,type,content,importance,tags,created_at&order=created_at.desc&limit=2`;
    ...
    console.log('Latest two memories:');
